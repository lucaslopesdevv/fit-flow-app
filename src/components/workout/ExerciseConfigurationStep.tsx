...
const ExerciseConfigurationStep = memo(
  ({ exercises, onExerciseUpdate, onValidationChange }: ExerciseConfigurationStepProps) => {
    ...
    const handleFieldChange = useCallback(
      (exerciseId: string, field: keyof WorkoutExerciseConfig, value: string | number) => {
        ...
        if (field === 'sets' || field === 'reps' || field === 'restSeconds') {
          const validation = validateField(
            exerciseId,
            field as keyof ExerciseValidationState[string],
            value
          )
    ...
    const renderExerciseConfiguration = useCallback(
      ({ item, index }: { item: WorkoutExerciseConfig; index: number }) => {
        ...
        const exerciseValidation = validationState[item.exerciseId] || {
          sets: false,
          reps: false,
          restSeconds: false,
        }
            ...
            >
              <View style={styles.exerciseHeaderContent}>
                ...
                <View style={styles.exerciseInfo}>
                  ...
                  <ThemedText style={styles.muscleGroup}>{item.exercise.muscle_group}</ThemedText>
                ...
                <View style={styles.headerActions}>
                  ...
                  <View
                    style={[
                      ...
                      exerciseValidation.sets &&
                      exerciseValidation.reps &&
                      exerciseValidation.restSeconds
                  ...
                  <View style={styles.reorderButtons}>
                    ...
                    <Button
                      ...
                      style={[
                        ...
                        index === exercises.length - 1 && styles.disabledButton,
                      ]}
                ...
                <View style={styles.configFields}>
                  <View style={styles.fieldRow}>
                    <Input
                      ...
                      onChangeText={value =>
                        handleFieldChange(item.exerciseId, 'sets', parseInt(value) || 0)
                      }
                  ...
                  <Input
                    ...
                    onChangeText={value =>
                      handleFieldChange(item.exerciseId, 'restSeconds', parseInt(value) || 0)
                    }
                    keyboardType="numeric"
                    ...
                    helperText={
                      item.restSeconds > 0
                        ? `Equivale a ${formatRestTime(item.restSeconds)}`
                        : undefined
                    }
                    required
                    ...
                    <View style={styles.previewContent}>
                      ...
                      <View style={styles.previewDetails}>
                        ...
                        <ThemedText style={styles.previewDetail}>
                          ⏱️{' '}
                          {item.restSeconds >= 0
                            ? `${formatRestTime(item.restSeconds)} de descanso`
                            : 'Descanso não definido'}
                        </ThemedText>
                        {item.notes && (
                          <ThemedText style={styles.previewDetail}>📝 {item.notes}</ThemedText>
                        )}
                      </View>
                    </View>
                  </Card>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.progressSection}>
            <ThemedText style={styles.progressText}>
              Progresso:{' '}
              {Object.values(validationState).filter(v => v.sets && v.reps && v.restSeconds).length}{' '}
              de {exercises.length} exercícios configurados
            </ThemedText>
